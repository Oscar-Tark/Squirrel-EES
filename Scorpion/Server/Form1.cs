    ...
    public partial class Form1 : Form
    {
        ...
        public void Start(string ip, int port)
        {
            ...
            try
            {
                ...
                SocketPermission permission = new SocketPermission(NetworkAccess.Connect, TransportType.Tcp, ip, SocketPermission.AllPorts);
        ...
        {
            Start(textBox1.Text, (int)numericUpDown1.Value);
        }
