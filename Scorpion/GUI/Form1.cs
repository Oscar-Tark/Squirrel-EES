...
namespace Scorpion
{
    public partial class Form1 : Form
    {
        ...
        private void init()
        {
            ...
            //Loads DB Objects to memory
            vds = new Dumper.Virtual_Dumper_System(this);

            //LoadSQL
            sql = new Scorpion.SQL_lite.SQL_lite(this);
            ...
            //Start game engine class
            RS = new Game_Engine.Scorpion_RS(this);

            initialize_enigine();

            //First_Use fu = new First_Use(this);
            start_CUI();
        ...
        public void initialize_enigine()
        {
            Orig_path = "";
            Prog_s = "";
