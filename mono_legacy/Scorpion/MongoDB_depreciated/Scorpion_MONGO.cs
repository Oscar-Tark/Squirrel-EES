...
namespace Scorpion
{
    partial class Librarian
    {
        ...
        */
        ...
        public object mongodbgetall(ref string Scorp_Line_Exec, ref ArrayList objects)
        {
            //returnable<<::*db, *collection
            //string JSON = null;

            ArrayList al_ret = new ArrayList();
            al_ret = Mongodb.mongoGetAll((string)var_get(objects[0]), (string)var_get(objects[1]));
            var_arraylist_dispose(ref objects);
            Scorp_Line_Exec = null;
            return var_create_return(ref al_ret);
        }

        public string mongodbfind(ref string Scorp_Line_Exec, ref ArrayList objects)
        {
            //returnable<<::*db, *collection, *filter
            string JSON = Mongodb.mongoFind((string)var_get(objects[0]), (string)var_get(objects[1]), (string)var_get(objects[2]));
            var_arraylist_dispose(ref objects);
            Scorp_Line_Exec = null;
        ...
        public object mongodblist(ref string Scorp_Line_Exec, ref ArrayList objects)
        {
            //*returns<<::
            ArrayList al_ret = Mongodb.mongoList();
            return var_create_return(ref al_ret);
        }
    }
}