...
namespace Scorpion_Hasher_Library
{
    public class Scorpion_Hasher
    {
        ...
        {
            return SecurePasswordHasher.Verify(password, hashed_password);
        }
    }
    ...
    static class SecurePasswordHasher
    {
        ...
        public static string Hash(string password, int iterations)
        {
            ...
            return string.Format("$SCH$V1a${0}${1}", iterations, base64Hash);
        }
        ...
        {
            return hashString.Contains("$SCH$V1a$");
        }
        ...
        public static bool Verify(string password, string hashedPassword)
        {
            ...
            var splittedHashString = hashedPassword.Replace("$SCH$V1a$", "").Split('$');
